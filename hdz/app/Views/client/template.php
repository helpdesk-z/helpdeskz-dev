...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        <a class="navbar-brand" href="<?php echo site_url();?>"><img src="<?php echo site_logo();?>" style="width: 120px" class="img-fluid"></a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-md-right">
                <a href="https://hotro.osd.vn">Trung tâm Hỗ trợ khách hàng</a>
            </div>
        </div>
    </div>
</div>
