...
?>
<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/tinymce/5.10.4/tinymce.min.js"></script>
<script>
$(function(){
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="form-group">
                    <textarea name="message" id="message" rows="10" class="form-control <?php echo ($validation->hasError('message') ? 'is-invalid' : '');?>" required><?php echo set_value('message');?></textarea>
                </div>
                <?php
